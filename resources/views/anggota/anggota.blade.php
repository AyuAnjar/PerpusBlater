      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
                <div>
                    <button type="button" class="btn btn-sm btn-primary" onclick="window.location='{{ url('anggota/create') }}'">
                        ...
                        <tr>
                            ...
                            <td>
                              <form action="{{ route('anggota.destroy', $anggota->id_anggota)}} " method="POST">
                                <a href="{{ route('anggota.edit', $anggota->id_anggota) }}" class="btn btn-md btn-warning">EDIT</a>
                                @csrf
                                @method("delete")
