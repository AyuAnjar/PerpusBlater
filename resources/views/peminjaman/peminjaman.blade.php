      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
                <div>
                    <button type="button" class="btn btn-sm btn-primary" onclick="window.location='{{ url('peminjaman/create') }}'">
                        <i class="fas fa-plus-circle"></i> Add New Data
                    </button>
                  </div>
              <div class="card-header">
                <h3 class="card-title">Data Peminjaman Buku Perpustakaan Blater</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
