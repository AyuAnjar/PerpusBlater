  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Form New Data Peminjaman</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                        ...
                        <div class="card border-0 shadow-sm rounded">
                            <div class="card-body">
                              ...
                              <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tgl_pinjam') is-invalid @enderror" name="tgl_pinjam" value="{{ old('tgl_pinjam') }}" placeholder="Masukkan Tanggal Peminjaman">
