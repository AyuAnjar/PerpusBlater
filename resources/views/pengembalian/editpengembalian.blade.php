  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Form Edit Data Pengembalian</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
            ...
            <div class="card">
                <div>
                    <button type="button" class="btn btn-sm btn-warning" onclick="window.location='{{ url('pengembalian') }}'">
                        <i><i class="fas fa-arrow-left"></i></i> Kembali
                    </button>
                  </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card border-0 shadow-sm rounded">
                            <div class="card-body">
                                <form action="{{ route('pengembalian.update', $pengembalian->id_pengembalian) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('id_pengembalian') is-invalid @enderror" name="id_pengembalian" value="{{ old('id_pengembalian',$pengembalian->id_pengembalian) }}" placeholder="Masukkan ID Pengembalian Post">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" value="{{ old('judul ', $pengembalian->judul) }}" placeholder="Masukkan Judul">
                              ...
                              <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tgl_kembali') is-invalid @enderror" name="tgl_kembali" value="{{ old('tgl_kembali', $pengembalian->tgl_kembali) }}" placeholder="Masukkan Tanggal Kembali">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('denda') is-invalid @enderror" name="denda" value="{{ old('denda', $pengembalian->denda) }}" placeholder="Masukkan Denda">
